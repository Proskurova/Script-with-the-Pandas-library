# Скрипт, соединяет 2 базы данных и наи ноличие одинаковых номеров, в разных форматах и делит на три базы.
...
bd1 = pd.read_excel("Database1.xlsx")# В скобки название своей таблицы xlsx
df1 = pd.DataFrame(bd1)
bd2 = pd.read_excel("Database2.xlsx")# В скобки название своей таблицы xlsx
...
for value in df1["Номер"]:# Визде вместо "Номер" указать название таблицы с номерами
